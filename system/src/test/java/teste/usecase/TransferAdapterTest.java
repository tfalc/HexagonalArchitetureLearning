...
public class TransferAdapterTest {
    ...
    void pesquisaContaNumeroExistente(){
        System.out.println("=== Testando pesquisa de conta com número existente ===");
        try{
            var conta = transferPortUseCase.getConta(contaCredito);
            assertTrue(conta != null, "Conta deve ser nula.");
            System.out.println(conta);
        }catch (NegocioException e){
            fail("Conta existente carregada.");
        }
    }
